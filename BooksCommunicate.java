...
class BooksCommunicate implements Runnable{
	 
	 Book book;
	 
	 public BooksCommunicate(Book book) {
	  super();
	  this.book = book;
	 }
...
public class BooksCommunicate {

	public static void main(String[] args) {
		 // Book object on which wait and notify method will be called
		 Book book=new Book("The Alchemist");
		 BooksRead johnReader=new BooksRead(book);
		 BooksRead arpitReader=new BooksRead(book);
